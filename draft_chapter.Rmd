...
- Accessing open data using Application Programming Interfaces (APIs) and direct downloads.
...
First, we will go through how to access the data used in the exercises: an important skill when seeking to use open data.
